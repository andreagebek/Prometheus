...
gridsDict['rho_steps'] = read_value('Enter the number of bins for the spatial discretization in radial direction (rho-direction):', 2., 1e6, 1.)
if fundamentalsDict['RM_effect']: # If the RM-effect is active you have to integrate numerically over the entire stellar disk
