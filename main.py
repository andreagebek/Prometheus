...
def optical_depth(z, wavelength):   
    ...
    tau = 0
    for idx_scenario, key_scenario in enumerate(param['Scenarios'].keys()):
        number_density = number_density_dict[key_scenario]
        n = number_density(r, param['Scenarios'][key_scenario])
        ...
        for key_species in param['Species'].keys():
            ...
            chi = param['Species'][key_species][idx_scenario][1]

            if key_scenario == 'barometric' or key_scenario == 'hydrostatic':
                T = param['Species'][key_species][idx_scenario][2]

            else:
                v_mean = param['Species'][key_species][idx_scenario][2]
